...
var catalogHorizontalResize = new Resizing({
    ...
    // resizeListener: filter.childrenShare()
});
...
// custom scrollbar
[].forEach.call(document.querySelectorAll('.table-body'), function(el) { new SimpleBar(el); });
new SimpleBar(document.querySelector('.detail-goods-box-scroll__hold'));

new SimpleBar(document.querySelector('.card-list'));
